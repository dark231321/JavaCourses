package danil.teterin.atomic.lesson1;

import com.squareup.okhttp.*;
import danil.teterin.atomic.lessons.lessons1.chat.client.ChatClient;
...
public class ChatServiceClientTest {
    ...
    public void login() throws IOException {
        ...
        Assert.assertTrue(response.code() == 200  || body.equals("User already login"));
    }
